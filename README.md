...
> Answer:  The one obvious reason would be page-refreshing. This makes a site feel more responsive and quicker, when not having to reload the whole site for a single page of content. As a user clicks the "white flash" doesn't happen as drastically and a traditional server-side rendering app.
